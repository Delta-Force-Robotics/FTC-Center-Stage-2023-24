...
public class HardwareConstants {
    ...
    // Slide motors
    public static final String ID_SLIDE_MOTOR_LEFT = "slideMotorLeft";
    public static final String ID_SLIDE_MOTOR_RIGHT = "slideMotorRight";

    public static final String ID_INTSKE_MOTOR = "intakeMotor";
    public static final String ID_CLIMB_MOTOR = "climbMotor";

    // Claw servos
    public static final String ID_CLAW_SERVO = "clawServo";
    ...
    public static final String ID_RIGHT_ENCODER = "rb";
    public static final String ID_LATERAL_ENCODER = "strafeEncoder";
