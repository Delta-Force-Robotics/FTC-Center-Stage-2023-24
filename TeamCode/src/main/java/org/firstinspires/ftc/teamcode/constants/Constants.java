...
public class Constants {
    ...
    public static double SLIDE_MOTOR_PASSIVE_POWER = 0.16;
    ...
    public static PIDFCoefficients SLIDE_RETRACT_PIDF_COEFF = new PIDFCoefficients(4.35, 0, 0, 0);
    public static PIDFCoefficients SLIDE_EXTEND_PIDF_COEFF = new PIDFCoefficients(7.3, 0, 0, 0);
    ...
    public static final double ROTATE_SERVO_INIT_POSITION = 0.22;
    public static final double ROTATE_SERVO_45 = 0.33; //L
    public static final double ROTATE_SERVO_180 = 0.095; //R
    ...
    public static final int CLIMB_MOTOR_CLIMB_POS = -6836;

    public static final double CLIMB_MOTOR_INIT_POS_METERS = 0.03;
    public static final double CLIMB_MOTOR_CLIMB_POS_METERS = 0.09;
    public static final double CLIMB_MAX_EXTENSION_METERS = 0.119;

    public static double CLIMB_MOTOR_PASSIVE_POWER = 0.5;
